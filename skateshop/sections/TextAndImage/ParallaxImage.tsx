...
type ParallaxImageProps = {
  foregroundImage: { url: string; alt?: string };
    ...
    <div className="grid grid-cols-1 place-items-center">
      ...
      >
        <Image
          ...
          width={400}
          height={500}
          className={clsx("object-cover rounded-lg opacity-60 w-11/12")}
        />
      </div>
      <div
        ref={foregroundRef}
      ...
      >
        <Image
          ...
          width={400}
          height={500}
          className="h-full max-h-[500px] w-auto object-contain rounded-lg"
        />
      </div>
    </div>
  );
